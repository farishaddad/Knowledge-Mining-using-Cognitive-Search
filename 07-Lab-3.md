...
####Step 7.1 - Challenge!!
As you can see, again we are not giving you the body request. You need to change it, recreating your data pipeline. You need to use the first lab body request and add this custom skill as described in the previous step. We can't use lab 2 definition because on the maximum number os skills within a skillset of a basic account.
